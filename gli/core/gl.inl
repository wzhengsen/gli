...
namespace detail
{
		...
		: Profile(Profile)
	{
		...
		format_desc const Table[] =
		{
			...
			{INTERNAL_RGBA4, EXTERNAL_RGBA, TYPE_UINT16_RGBA4, detail::FORMAT_PROPERTY_BGRA_BIT},		//FORMAT_BGRA4_UNORM,
			{INTERNAL_R5G6B5, EXTERNAL_RGB, TYPE_UINT16_R5G6B5_REV, 0},									//FORMAT_R5G6B5_UNORM,
			{INTERNAL_R5G6B5, EXTERNAL_RGB, TYPE_UINT16_R5G6B5, detail::FORMAT_PROPERTY_BGRA_BIT},		//FORMAT_B5G6R5_UNORM,
			{INTERNAL_RGB5A1, EXTERNAL_RGBA, TYPE_UINT16_RGB5A1_REV, 0},								//FORMAT_RGB5A1_UNORM,
			{INTERNAL_RGB5A1, EXTERNAL_RGBA, TYPE_UINT16_RGB5A1, detail::FORMAT_PROPERTY_BGRA_BIT},		//FORMAT_BGR5A1_UNORM,
			...
			{INTERNAL_RGB8_UNORM, ExternalBGR, TYPE_U8, detail::FORMAT_PROPERTY_BGRA_BIT},				//FORMAT_BGR8_UNORM_PACK8,
			{INTERNAL_RGB8_SNORM, ExternalBGR, TYPE_I8, detail::FORMAT_PROPERTY_BGRA_BIT},				//FORMAT_BGR8_SNORM_PACK8,
			{INTERNAL_RGB8_USCALED_GTC, ExternalBGR, TYPE_U8, detail::FORMAT_PROPERTY_BGRA_BIT},		//FORMAT_BGR8_USCALED_PACK8,
			{INTERNAL_RGB8_SSCALED_GTC, ExternalBGR, TYPE_I8, detail::FORMAT_PROPERTY_BGRA_BIT},		//FORMAT_BGR8_SSCALED_PACK8,
			{INTERNAL_RGB8U, ExternalBGRInt, TYPE_U8, detail::FORMAT_PROPERTY_BGRA_BIT},				//FORMAT_BGR8_UINT_PACK8,
			{INTERNAL_RGB8I, ExternalBGRInt, TYPE_I8, detail::FORMAT_PROPERTY_BGRA_BIT},				//FORMAT_BGR8_SINT_PACK8,
			{INTERNAL_SRGB8, ExternalBGR, TYPE_U8, detail::FORMAT_PROPERTY_BGRA_BIT},					//FORMAT_BGR8_SRGB_PACK8,
			...
			{InternalBGRA, ExternalBGRA, TYPE_U8, detail::FORMAT_PROPERTY_BGRA_BIT},						//FORMAT_BGRA8_UNORM_PACK8,
			{INTERNAL_RGBA8_SNORM, ExternalBGRA, TYPE_I8, detail::FORMAT_PROPERTY_BGRA_BIT},				//FORMAT_BGRA8_SNORM_PACK8,
			{INTERNAL_RGBA8_USCALED_GTC, ExternalBGRA, TYPE_U8, detail::FORMAT_PROPERTY_BGRA_BIT},			//FORMAT_BGRA8_USCALED_PACK8,
			{INTERNAL_RGBA8_SSCALED_GTC, ExternalBGRA, TYPE_I8, detail::FORMAT_PROPERTY_BGRA_BIT},			//FORMAT_BGRA8_SSCALED_PACK8,
			{INTERNAL_RGBA8U, ExternalBGRAInt, TYPE_U8, detail::FORMAT_PROPERTY_BGRA_BIT},					//FORMAT_BGRA8_UINT_PACK8,
			{INTERNAL_RGBA8I, ExternalBGRAInt, TYPE_I8, detail::FORMAT_PROPERTY_BGRA_BIT},					//FORMAT_BGRA8_SINT_PACK8,
			{INTERNAL_SRGB8_ALPHA8, ExternalBGRA, TYPE_U8, detail::FORMAT_PROPERTY_BGRA_BIT},				//FORMAT_BGRA8_SRGB_PACK8,
			...
			{INTERNAL_RGB10A2_UNORM, EXTERNAL_RGBA, TYPE_UINT32_RGB10A2, detail::FORMAT_PROPERTY_BGRA_BIT},				//FORMAT_BGR10A2_UNORM_PACK32,
			{INTERNAL_RGB10A2_SNORM_EXT, EXTERNAL_RGBA, TYPE_UINT32_RGB10A2, detail::FORMAT_PROPERTY_BGRA_BIT},			//FORMAT_BGR10A2_SNORM_PACK32,
			{INTERNAL_RGB10A2_USCALED_GTC, EXTERNAL_RGBA, TYPE_UINT32_RGB10A2, detail::FORMAT_PROPERTY_BGRA_BIT},		//FORMAT_BGR10A2_USCALE_PACK32,
			{INTERNAL_RGB10A2_SSCALED_GTC, EXTERNAL_RGBA, TYPE_UINT32_RGB10A2, detail::FORMAT_PROPERTY_BGRA_BIT},		//FORMAT_BGR10A2_SSCALE_PACK32,
			{INTERNAL_RGB10A2U, EXTERNAL_RGBA_INTEGER, TYPE_UINT32_RGB10A2, detail::FORMAT_PROPERTY_BGRA_BIT},			//FORMAT_BGR10A2_UINT_PACK32,
			{INTERNAL_RGB10A2I_EXT, EXTERNAL_RGBA_INTEGER, TYPE_UINT32_RGB10A2, detail::FORMAT_PROPERTY_BGRA_BIT},		//FORMAT_BGR10A2_SINT_PACK32,
	...
	inline gl::format gl::translate(gli::format Format, gli::swizzles const& Swizzles) const
	{
		...
		bool const IsExternalBGRA = (FormatDesc.Properties & detail::FORMAT_PROPERTY_BGRA_BIT) && use_external_bgra(this->Profile);
