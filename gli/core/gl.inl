...
namespace gli
{
	inline gl::gl(profile Profile)
	{
		static format const Table[] =
		{
			...
			{INTERNAL_RGB5A1, EXTERNAL_RGBA, TYPE_UINT16_A1RGB5_GTC},		//FORMAT_A1RGB5_UNORM,

			{INTERNAL_R8_UNORM, EXTERNAL_RED, TYPE_U8},						//FORMAT_R8_UNORM,
			{INTERNAL_R8_SNORM, EXTERNAL_RED, TYPE_I8},						//FORMAT_R8_SNORM,
			{INTERNAL_R8_USCALED_GTC, EXTERNAL_RED, TYPE_U8},				//FORMAT_R8_USCALED,
			{INTERNAL_R8_SSCALED_GTC, EXTERNAL_RED, TYPE_I8},				//FORMAT_R8_SSCALED,
			...
			{INTERNAL_RG8_USCALED_GTC, EXTERNAL_RG, TYPE_U8},				//FORMAT_RG8_USCALED,
			{INTERNAL_RG8_SSCALED_GTC, EXTERNAL_RG, TYPE_I8},				//FORMAT_RG8_SSCALED,
			...
			{INTERNAL_RGB8_USCALED_GTC, EXTERNAL_RGB, TYPE_U8},				//FORMAT_RGB8_USCALED,
			{INTERNAL_RGB8_SSCALED_GTC, EXTERNAL_RGB, TYPE_I8},				//FORMAT_RGB8_SSCALED,
			...
			{INTERNAL_RGB8_USCALED_GTC, EXTERNAL_BGR, TYPE_U8},				//FORMAT_BGR8_USCALED,
			{INTERNAL_RGB8_SSCALED_GTC, EXTERNAL_BGR, TYPE_I8},				//FORMAT_BGR8_SSCALED,
			...
			{INTERNAL_RGBA8_USCALED_GTC, EXTERNAL_RGBA, TYPE_U8},			//FORMAT_RGBA8_USCALED,
			{INTERNAL_RGBA8_SSCALED_GTC, EXTERNAL_RGBA, TYPE_I8},			//FORMAT_RGBA8_SSCALED,
			...
			{INTERNAL_RGBA8_USCALED_GTC, EXTERNAL_BGRA, TYPE_U8},					//FORMAT_BGRA8_USCALED,
			{INTERNAL_RGBA8_SSCALED_GTC, EXTERNAL_BGRA, TYPE_I8},					//FORMAT_BGRA8_SSCALED,
			...
			{INTERNAL_RGBA8_UNORM, EXTERNAL_RGBA, TYPE_UINT32_RGBA8_REV},				//FORMAT_ABGR8_UNORM,
			{INTERNAL_RGBA8_SNORM, EXTERNAL_RGBA, TYPE_UINT32_RGBA8_REV},				//FORMAT_ABGR8_SNORM,
			{INTERNAL_RGBA8_USCALED_GTC, EXTERNAL_RGBA, TYPE_UINT32_RGBA8_REV},			//FORMAT_ABGR8_USCALED,
			{INTERNAL_RGBA8_SSCALED_GTC, EXTERNAL_RGBA, TYPE_UINT32_RGBA8_REV},			//FORMAT_ABGR8_SSCALED,
			{INTERNAL_RGBA8U, EXTERNAL_RGBA_INTEGER, TYPE_UINT32_RGBA8_REV},			//FORMAT_ABGR8_UINT,
			{INTERNAL_RGBA8I, EXTERNAL_RGBA_INTEGER, TYPE_UINT32_RGBA8_REV},			//FORMAT_ABGR8_SINT,
			{INTERNAL_SRGB8_ALPHA8, EXTERNAL_RGBA, TYPE_UINT32_RGBA8_REV},				//FORMAT_ABGR8_SRGB,
			...
			{INTERNAL_RGB10A2_USCALED_GTC, EXTERNAL_RGBA, TYPE_UINT32_RGB10A2_REV},		//FORMAT_RGB10A2_USCALE,
			{INTERNAL_RGB10A2_SSCALED_GTC, EXTERNAL_RGBA, TYPE_UINT32_RGB10A2_REV},		//FORMAT_RGB10A2_SSCALE,
			...
			{INTERNAL_RGB10A2_USCALED_GTC, EXTERNAL_RGBA, TYPE_UINT32_RGB10A2},		//FORMAT_BGR10A2_USCALE,
			{INTERNAL_RGB10A2_SSCALED_GTC, EXTERNAL_RGBA, TYPE_UINT32_RGB10A2},		//FORMAT_BGR10A2_SSCALE,
			...
			{INTERNAL_R16_USCALED_GTC, EXTERNAL_RED, TYPE_U16},				//FORMAT_R16_USCALED_PACK16,
			{INTERNAL_R16_SSCALED_GTC, EXTERNAL_RED, TYPE_I16},				//FORMAT_R16_SSCALED_PACK16,
			...
			{INTERNAL_RG16_USCALED_GTC, EXTERNAL_RG, TYPE_U16},				//FORMAT_RG16_USCALED_PACK16,
			{INTERNAL_RG16_SSCALED_GTC, EXTERNAL_RG, TYPE_I16},				//FORMAT_RG16_SSCALED_PACK16,
			...
			{INTERNAL_RGB16_USCALED_GTC, EXTERNAL_RGB, TYPE_U16},			//FORMAT_RGB16_USCALED_PACK16,
			{INTERNAL_RGB16_SSCALED_GTC, EXTERNAL_RGB, TYPE_I16},			//FORMAT_RGB16_USCALED_PACK16,
			...
			{INTERNAL_RGBA16_USCALED_GTC, EXTERNAL_RGBA, TYPE_U16},			//FORMAT_RGBA16_USCALED_PACK16,
			{INTERNAL_RGBA16_SSCALED_GTC, EXTERNAL_RGBA, TYPE_I16},			//FORMAT_RGBA16_SSCALED_PACK16,
			...
			{INTERNAL_LUMINANCE8, EXTERNAL_LUMINANCE, TYPE_U8},						//FORMAT_L8_UNORM_PACK8,
			{INTERNAL_ALPHA8, EXTERNAL_ALPHA, TYPE_U8},								//FORMAT_A8_UNORM_PACK8,
			{INTERNAL_LUMINANCE8_ALPHA8, EXTERNAL_LUMINANCE_ALPHA, TYPE_U8},		//FORMAT_LA8_UNORM_PACK8,
			{INTERNAL_LUMINANCE16, EXTERNAL_LUMINANCE, TYPE_U16},					//FORMAT_L16_UNORM_PACK16,
			{INTERNAL_ALPHA16, EXTERNAL_ALPHA, TYPE_U16},							//FORMAT_A16_UNORM_PACK16,
			{INTERNAL_LUMINANCE16_ALPHA16, EXTERNAL_LUMINANCE_ALPHA, TYPE_U16},		//FORMAT_LA16_UNORM_PACK16,
