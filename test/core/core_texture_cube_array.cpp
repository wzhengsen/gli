...
int test_alloc()
{
	...
	std::vector<gli::texture_cube_array::texelcoord_type::value_type> Sizes;
	Sizes.push_back(16);
	Sizes.push_back(32);
	Sizes.push_back(15);
	Sizes.push_back(17);
	...
	{
		gli::texture_cube_array::texelcoord_type Size(Sizes[SizeIndex]);
...
int test_textureCubeArray_query()
{
	...
	{
		gli::texture_cube_array Texture(gli::FORMAT_RGBA8_UINT_PACK8, gli::texture_cube_array::texelcoord_type(2), 1);
	...
	{
		gli::texture_cube_array Texture(gli::FORMAT_RGBA8_UINT_PACK8, gli::texture_cube_array::texelcoord_type(2), 4);
...
int test_textureCubeArray_textureCube_access()
{
	...
	{
		gli::texture_cube TextureCube(gli::FORMAT_RGBA8_UINT_PACK8, gli::texture_cube::texelcoord_type(2), 1);
...
struct test
{
	test(
		...
		gli::texture_cube::texelcoord_type const & Dimensions,
	...
	gli::format Format;
	gli::texture_cube::texelcoord_type Dimensions;
...
int test_textureCubeArray_textureCube_size()
{
	...
	Tests.push_back(test(gli::FORMAT_RGBA8_UINT_PACK8, gli::texture_cube::texelcoord_type(4), 384 * 4));
	Tests.push_back(test(gli::FORMAT_R8_UINT_PACK8, gli::texture_cube::texelcoord_type(4), 96 * 4));
	Tests.push_back(test(gli::FORMAT_RGBA_DXT1_UNORM_BLOCK8, gli::texture_cube::texelcoord_type(4), 48 * 4));
	Tests.push_back(test(gli::FORMAT_RGBA_DXT1_UNORM_BLOCK8, gli::texture_cube::texelcoord_type(2), 48 * 4));
	Tests.push_back(test(gli::FORMAT_RGBA_DXT1_UNORM_BLOCK8, gli::texture_cube::texelcoord_type(1), 48 * 4));
	Tests.push_back(test(gli::FORMAT_RGBA_DXT5_UNORM_BLOCK16, gli::texture_cube::texelcoord_type(4), 96 * 4));

	for(std::size_t i = 0; i < Tests.size(); ++i)
	{
		gli::texture_cube_array Texture(Tests[i].Format, gli::texture_cube::texelcoord_type(4), 4, 1);
...
namespace clear
{
	int run()
	{
		...
		gli::texture_cube_array Texture(gli::FORMAT_RGBA8_UINT_PACK8, gli::texture_cube_array::texelcoord_type(4), 4, 1);
...
namespace load
{
	int run()
	{
		...
		gli::texture_cube_array Texture(gli::FORMAT_RGBA8_UNORM_PACK8, gli::texture_cube_array::texelcoord_type(1), 2);
...
namespace load_store
{
	...
	int run(gli::format Format, std::array<genType, 6> const & TestSamples)
	{
		...
		gli::texture_cube_array::texelcoord_type const Dimensions(2, 2);
		...
		TextureB.clear();
		for(gli::size_t FaceIndex = 0, FaceCount = 6; FaceIndex < FaceCount; ++FaceIndex)
			TextureB.store(gli::texture_cube::texelcoord_type(0, 0), Layer, FaceIndex, Level, TestSamples[FaceIndex]);

		std::array<genType, 6> LoadedSamplesA;
		for(gli::size_t FaceIndex = 0, FaceCount = 6; FaceIndex < FaceCount; ++FaceIndex)
			LoadedSamplesA[FaceIndex] = TextureA.load<genType>(gli::texture_cube_array::texelcoord_type(0), Layer, FaceIndex, Level);

		std::array<genType, 6> LoadedSamplesB;
		for(gli::size_t FaceIndex = 0, FaceCount = 6; FaceIndex < FaceCount; ++FaceIndex)
			LoadedSamplesB[FaceIndex] = TextureB.load<genType>(gli::texture_cube_array::texelcoord_type(0), Layer, FaceIndex, Level);
...
namespace clear
{
	int test()
	{
		...
		gli::texture_cube_array Texture(gli::FORMAT_RGBA8_UNORM_PACK8, gli::texture_cube_array::texelcoord_type(4), 1);
		Texture.clear(Black);

		glm::u8vec4 const TexelA = Texture.load<glm::u8vec4>(gli::texture_cube_array::texelcoord_type(0), 0, 0, 0);
		glm::u8vec4 const TexelB = Texture.load<glm::u8vec4>(gli::texture_cube_array::texelcoord_type(0), 0, 0, 1);
		glm::u8vec4 const TexelC = Texture.load<glm::u8vec4>(gli::texture_cube_array::texelcoord_type(0), 0, 0, 2);
		...
		gli::texture_cube_array::texelcoord_type Coords(0);
		...
		gli::texture_cube_array TextureImage(gli::FORMAT_RGBA8_UNORM_PACK8, gli::texture_cube_array::texelcoord_type(2), 1, 1);
