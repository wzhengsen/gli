...
namespace load
{
	int test()
	{
		...
		gli::texture_cube Texture(gli::FORMAT_RGBA8_UNORM_PACK8, gli::texture_cube::texelcoord_type(1), 1);
...
namespace texture_lod
{
	int test()
	{
...

		{
			...
			Texture.store(gli::texture_cube::texelcoord_type(0), 0, 1, gli::u8vec4(255,   0,   0, 255));
			Texture.store(gli::texture_cube::texelcoord_type(0), 1, 1, gli::u8vec4(255, 127,   0, 255));
			Texture.store(gli::texture_cube::texelcoord_type(0), 2, 1, gli::u8vec4(255, 255,   0, 255));
			Texture.store(gli::texture_cube::texelcoord_type(0), 3, 1, gli::u8vec4(  0, 255,   0, 255));
			Texture.store(gli::texture_cube::texelcoord_type(0), 4, 1, gli::u8vec4(  0,   0, 255, 255));
			Texture.store(gli::texture_cube::texelcoord_type(0), 5, 1, gli::u8vec4(255,   0, 255, 255));
...
namespace sampler_type
{
	int test()
	{
		...
		{
			gli::texture_cube Texture(gli::FORMAT_RGBA8_UNORM_PACK8, gli::texture_cube::texelcoord_type(4), 1);
