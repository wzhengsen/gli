...
namespace load
{
	int test()
	{
		...
		gli::texture2DArray Texture(gli::FORMAT_RGBA8_UNORM_PACK8, gli::texture2DArray::texelcoord_type(4, 2), 1, 1);
...
namespace texture_lod
{
	int test()
	{
		...
		{
			gli::texture2DArray Texture(gli::FORMAT_RGBA8_UNORM_PACK8, gli::texture2DArray::texelcoord_type(4), 1, 1);
...
namespace sampler_type
{
	int test()
	{
		...
		{
			gli::texture2DArray Texture(gli::FORMAT_RGBA8_UNORM_PACK8, gli::texture2D::texelcoord_type(4), 1, 1);
