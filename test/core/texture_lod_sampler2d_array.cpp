...
namespace load
{
	int test()
	{
		...
		gli::texture2d_array Texture(gli::FORMAT_RGBA8_UNORM_PACK8, gli::texture2d_array::texelcoord_type(4, 2), 1, 1);
		...
		*(Texture.data<glm::u8vec4>() + 7) = glm::u8vec4(255,   0, 255, 255);
		...
		glm::u8vec4 Data0 = Texture.load<glm::u8vec4>(gli::texture2d_array::texelcoord_type(0, 0), 0, 0);
		glm::u8vec4 Data1 = Texture.load<glm::u8vec4>(gli::texture2d_array::texelcoord_type(1, 0), 0, 0);
		glm::u8vec4 Data2 = Texture.load<glm::u8vec4>(gli::texture2d_array::texelcoord_type(2, 0), 0, 0);
		glm::u8vec4 Data3 = Texture.load<glm::u8vec4>(gli::texture2d_array::texelcoord_type(3, 0), 0, 0);
		glm::u8vec4 Data4 = Texture.load<glm::u8vec4>(gli::texture2d_array::texelcoord_type(0, 1), 0, 0);
		glm::u8vec4 Data5 = Texture.load<glm::u8vec4>(gli::texture2d_array::texelcoord_type(1, 1), 0, 0);
		glm::u8vec4 Data6 = Texture.load<glm::u8vec4>(gli::texture2d_array::texelcoord_type(2, 1), 0, 0);
		glm::u8vec4 Data7 = Texture.load<glm::u8vec4>(gli::texture2d_array::texelcoord_type(3, 1), 0, 0);
...
namespace texture_lod
{
	int test()
	{
		...
		{
			gli::texture2d_array Texture(gli::FORMAT_RGBA8_UNORM_PACK8, gli::texture2d_array::texelcoord_type(4), 1, 1);
...
namespace sampler_type
{
	int test()
	{
		...
		{
			gli::texture2d_array Texture(gli::FORMAT_RGBA8_UNORM_PACK8, gli::texture2d::texelcoord_type(4), 1, 1);
