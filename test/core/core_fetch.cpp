...
namespace fetch_r8_unorm
{
	int test()
	{
		...
		gli::texture2d TextureA(gli::FORMAT_R8_UNORM_PACK8, gli::texture2d::texelcoord_type(2, 2));
		{
			...
			TextureA.store<glm::u8vec1>(gli::texture2d::texelcoord_type(1, 1), 0, glm::u8vec1(3));
			TextureA.store<glm::u8vec1>(gli::texture2d::texelcoord_type(0, 1), 0, glm::u8vec1(4));
			TextureA.store<glm::u8vec1>(gli::texture2d::texelcoord_type(0, 0), 1, glm::u8vec1(5));
...
namespace fetch_rg8_unorm
{
	int test()
	{
		...
		gli::texture2d TextureA(gli::FORMAT_RG8_UNORM_PACK8, gli::texture2d::texelcoord_type(2, 2));
		{
			...
			TextureA.store<glm::u8vec2>(gli::texture2d::texelcoord_type(1, 1), 0, glm::u8vec2(5, 6));
			TextureA.store<glm::u8vec2>(gli::texture2d::texelcoord_type(0, 1), 0, glm::u8vec2(7, 8));
			TextureA.store<glm::u8vec2>(gli::texture2d::texelcoord_type(0, 0), 1, glm::u8vec2(9, 5));
...
namespace fetch_rgb8_unorm
{
	int test()
	{
		...
		gli::texture2d TextureA(gli::FORMAT_RGB8_UNORM_PACK8, gli::texture2d::texelcoord_type(2, 2));
		{
			...
			TextureA.store<glm::u8vec3>(gli::texture2d::texelcoord_type(1, 1), 0, glm::u8vec3(0, 255, 0));
			TextureA.store<glm::u8vec3>(gli::texture2d::texelcoord_type(0, 1), 0, glm::u8vec3(0, 0, 255));
			TextureA.store<glm::u8vec3>(gli::texture2d::texelcoord_type(0, 0), 1, glm::u8vec3(255, 128, 0));
...
namespace fetch_rgba8_unorm
{
	int test()
	{
		...
		gli::texture2d TextureA(gli::FORMAT_RGBA8_UNORM_PACK8, gli::texture2d::texelcoord_type(2, 2));
		{
			...
			TextureA.store<glm::u8vec4>(gli::texture2d::texelcoord_type(1, 1), 0, glm::u8vec4(0, 255, 0, 255));
			TextureA.store<glm::u8vec4>(gli::texture2d::texelcoord_type(0, 1), 0, glm::u8vec4(0, 0, 255, 255));
			TextureA.store<glm::u8vec4>(gli::texture2d::texelcoord_type(0, 0), 1, glm::u8vec4(255, 128, 0, 255));
...
namespace fetch_rgb10a2_unorm
{
	int test()
	{
		...
		gli::texture2d TextureA(gli::FORMAT_RGB10A2_UNORM_PACK32, gli::texture2d::texelcoord_type(2, 2));
		{
			...
			TextureA.store<glm::uint32>(gli::texture2d::texelcoord_type(1, 1), 0, ColorG);
			TextureA.store<glm::uint32>(gli::texture2d::texelcoord_type(0, 1), 0, ColorB);
			TextureA.store<glm::uint32>(gli::texture2d::texelcoord_type(0, 0), 1, ColorO);
...
namespace fetch_srgb8_unorm
{
	int test()
	{
		...
		gli::texture2d TextureA(gli::FORMAT_RGB8_SRGB_PACK8, gli::texture2d::texelcoord_type(2, 2));
		{
			...
			TextureA.store<glm::u8vec3>(gli::texture2d::texelcoord_type(1, 1), 0, glm::u8vec3(glm::convertLinearToSRGB(glm::vec3(0, 255, 0))));
			TextureA.store<glm::u8vec3>(gli::texture2d::texelcoord_type(0, 1), 0, glm::u8vec3(glm::convertLinearToSRGB(glm::vec3(0, 0, 255))));
			TextureA.store<glm::u8vec3>(gli::texture2d::texelcoord_type(0, 0), 1, glm::u8vec3(glm::convertLinearToSRGB(glm::vec3(255, 128, 0))));
...
namespace fetch_srgba8_unorm
{
	int test()
	{
		...
		gli::texture2d TextureA(gli::FORMAT_RGBA8_SRGB_PACK8, gli::texture2d::texelcoord_type(2, 2));
		{
			...
			TextureA.store<glm::u8vec4>(gli::texture2d::texelcoord_type(1, 1), 0, glm::u8vec4(glm::convertLinearToSRGB(glm::vec4(0.0f, 1.0f, 0.0f, 1.0f))));
			TextureA.store<glm::u8vec4>(gli::texture2d::texelcoord_type(0, 1), 0, glm::u8vec4(glm::convertLinearToSRGB(glm::vec4(0.0f, 0.0f, 1.0f, 1.0f))));
			TextureA.store<glm::u8vec4>(gli::texture2d::texelcoord_type(0, 0), 1, glm::u8vec4(glm::convertLinearToSRGB(glm::vec4(1.0f, 0.5f, 0.0f, 1.0f))));
...
namespace fetch_bgr8_unorm
{
	int test()
	{
		...
		gli::texture2d TextureA(gli::FORMAT_RGB8_UNORM_PACK8, gli::texture2d::texelcoord_type(2, 2));
		{
			...
			TextureA.store<glm::u8vec3>(gli::texture2d::texelcoord_type(1, 1), 0, glm::u8vec3(0, 255, 0));
			TextureA.store<glm::u8vec3>(gli::texture2d::texelcoord_type(0, 1), 0, glm::u8vec3(255, 0, 0));
			TextureA.store<glm::u8vec3>(gli::texture2d::texelcoord_type(0, 0), 1, glm::u8vec3(0, 128, 255));
			gli::save_dds(TextureA, "rgb8_unorm_4pixels.dds");
		}
...
namespace fetch_bgra8_unorm
{
	int test()
	{
		...
		gli::texture2d TextureA(gli::FORMAT_BGRA8_UNORM_PACK8, gli::texture2d::texelcoord_type(2, 2));
		{
			...
			TextureA.store<glm::u8vec4>(gli::texture2d::texelcoord_type(1, 1), 0, glm::u8vec4(0, 255, 0, 255));
			TextureA.store<glm::u8vec4>(gli::texture2d::texelcoord_type(0, 1), 0, glm::u8vec4(255, 0, 0, 255));
			TextureA.store<glm::u8vec4>(gli::texture2d::texelcoord_type(0, 0), 1, glm::u8vec4(0, 128, 255, 255));
...
namespace fetch_rgba16f
{
	int test()
	{
		...
		gli::texture2d TextureA(gli::FORMAT_RGBA16_SFLOAT_PACK16, gli::texture2d::texelcoord_type(2, 2));
		{
			...
			TextureA.store<glm::u64>(gli::texture2d::texelcoord_type(1, 1), 0, glm::packHalf4x16(glm::vec4(0.0f, 1.0f, 0.0f, 1.0f)));
			TextureA.store<glm::u64>(gli::texture2d::texelcoord_type(0, 1), 0, glm::packHalf4x16(glm::vec4(0.0f, 0.0f, 1.0f, 1.0f)));
			TextureA.store<glm::u64>(gli::texture2d::texelcoord_type(0, 0), 1, glm::packHalf4x16(glm::vec4(1.0f, 0.5f, 0.0f, 1.0f)));
...
namespace fetch_rgb32f
{
	int test()
	{
		...
		gli::texture2d TextureA(gli::FORMAT_RGB32_SFLOAT_PACK32, gli::texture2d::texelcoord_type(2, 2));
		{
			...
			TextureA.store<glm::vec3>(gli::texture2d::texelcoord_type(1, 1), 0, glm::vec3(0.0f, 1.0f, 0.0f));
			TextureA.store<glm::vec3>(gli::texture2d::texelcoord_type(0, 1), 0, glm::vec3(0.0f, 0.0f, 1.0f));
			TextureA.store<glm::vec3>(gli::texture2d::texelcoord_type(0, 0), 1, glm::vec3(1.0f, 0.5f, 0.0f));
...
namespace fetch_rgb9e5
{
	int test()
	{
		...
		gli::texture2d TextureA(gli::FORMAT_RGB9E5_UFLOAT_PACK32, gli::texture2d::texelcoord_type(2, 2));
		{
			...
			TextureA.store<glm::uint32_t>(gli::texture2d::texelcoord_type(1, 1), 0, glm::uint32_t(5));
			TextureA.store<glm::uint32_t>(gli::texture2d::texelcoord_type(0, 1), 0, glm::uint32_t(7));
			TextureA.store<glm::uint32_t>(gli::texture2d::texelcoord_type(0, 0), 1, glm::uint32_t(9));
...
namespace fetch_rg11b10f
{
	int test()
	{
		...
		gli::texture2d TextureA(gli::FORMAT_RG11B10_UFLOAT_PACK32, gli::texture2d::texelcoord_type(2, 2));
		{
			...
			TextureA.store<glm::uint32_t>(gli::texture2d::texelcoord_type(1, 1), 0, glm::packF2x11_1x10(glm::vec3(0.0f, 1.0f, 0.0f)));
			TextureA.store<glm::uint32_t>(gli::texture2d::texelcoord_type(0, 1), 0, glm::packF2x11_1x10(glm::vec3(0.0f, 0.0f, 1.0f)));
			TextureA.store<glm::uint32_t>(gli::texture2d::texelcoord_type(0, 0), 1, glm::packF2x11_1x10(glm::vec3(1.0f, 0.5f, 0.0f)));
